    ...
    return (
        <View style={styles.confirm_buttons_wrap}>
            <View style={styles.confirm_button}>
                <Button title={I18n.t("confirm_code").toUpperCase()} onPress={props.sendData} iconName="ios-arrow-round-forward" />
            </View>
            <View style={styles.resend_sms_button}>
                <TouchableHighlight onPress={props.goBack}>
                    <Text style={styles.resend_sms_text}>{I18n.t("resend_confirmation_code")}</Text>
                </TouchableHighlight>
            </View>
        </View>
    )
