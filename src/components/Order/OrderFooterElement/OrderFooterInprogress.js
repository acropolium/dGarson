        ...
        <ImageBackground source={require('../../../media/elements/inprogress.gif')} style={{ width: windowWidth, backgroundColor: '#2a2a32' }}>
            <View style={[styles.footer_main, { backgroundColor: 'transparent' }]}>
                <View style={styles.total_block}>
                    ...
                    <Text style={[styles.total_color]}>{parseFloat(props.orderCost).toFixed(2)} {I18n.t("uah")}</Text>
                </View>
                <View>
                    <View style={[styles.preview_main]}>
                        <Text style={[styles.custom_font, styles.text]}>{I18n.t("order_" + props.orderState).toUpperCase()}</Text>
                    </View>
                </View>
            </View>
        </ImageBackground >
