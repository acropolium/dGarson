        ...
        <TouchableHighlight underlayColor='#ddd' onPress={props.press} >
            <View style={styles.order_block_additions}>
                <View style={styles.order_additions_element}>
                    <Text style={[styles.custom_font, styles.order_block_additions_text]}>{props.leftText}</Text>
                    <Text style={[styles.custom_font, styles.order_block_additions_text]}> {props.rightText}</Text>
                </View>
                <View style={styles.item_icon_collapse}>
                    <Icon name={props.iconName} iconFamily={props.iconFamily} size={25} />
                </View>
            </View>
        </TouchableHighlight>
    )
